...
//                + " existing key " + com.fecripve.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.fecripve.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.fecripve.core.coins.nxt.Crypto.rsDecode(com.fecripve.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.fecripve.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.fecripve.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.fecripve.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.fecripve.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.fecripve.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.fecripve.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
